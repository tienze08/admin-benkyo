...
const Packages = () => {
  ...
  const handleCreate = async () => {
    if (!formData.name || !formData.price || !formData.type || !formData.duration) {
      return
    }
      ...
      <DashboardLayout>
        <div className="flex items-center justify-center h-64">
          <div className="text-center">
            <h2 className="text-lg font-semibold text-destructive">Error loading packages</h2>
          ...
          <Dialog open={isCreateDialogOpen} onOpenChange={handleCreateDialogOpen}>
            ...
            <DialogContent className="sm:max-w-[425px] bg-white">
              <DialogHeader>
                ...
                <DialogDescription>Add a new subscription package with pricing and features.</DialogDescription>
              </DialogHeader>
          ...
          <CardContent>
            {isLoading ? (
              ...
              <Table>
                ...
                <TableBody>
                  {packages.map((pkg) => (
                    <TableRow key={pkg.id} className="border-b border-sidebar-border">
                      <TableCell className="font-medium">{pkg.name}</TableCell>
                      <TableCell>{pkg.type}</TableCell>
                      <TableCell>${pkg.price.toFixed(2)}</TableCell>
                      <TableCell>{getDurationLabel(pkg.duration)}</TableCell>
                      <TableCell>
